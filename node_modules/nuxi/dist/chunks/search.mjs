...
import { s as sharedArgs } from '../shared/nuxi.a0d06cf3.mjs';
import 'node:util';
import 'node:path';
import 'node:process';
import 'node:tty';
import { g as getNuxtVersion, f as fetchModules, c as checkNuxtCompatibility } from '../shared/nuxi.1d04c475.mjs';
...
const search = defineCommand({
  ...
  args: {
    ...
    nuxtVersion: {
      type: "string",
      description: "Filter by Nuxt version and list compatible moduless only (auto detected by default)",
      required: false
    }
  },
  async setup(ctx) {
